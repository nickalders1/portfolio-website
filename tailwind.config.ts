	...
	theme: {
		...
		extend: {
			...
			fontSize: {
				...
				'fluid-lg': 'clamp(1.125rem, 1vw + 1rem, 1.25rem)',
				'fluid-xl': 'clamp(1.25rem, 1.5vw + 1rem, 1.5rem)',
				'fluid-2xl': 'clamp(1.5rem, 2vw + 1rem, 2rem)',
				'fluid-3xl': 'clamp(1.875rem, 3vw + 1rem, 3rem)',
				'fluid-4xl': 'clamp(2.25rem, 4vw + 1rem, 4rem)',
				'fluid-5xl': 'clamp(3rem, 5vw + 1rem, 5rem)',
				'fluid-6xl': 'clamp(3.75rem, 6vw + 1rem, 6rem)'
			},
			keyframes: {
				'accordion-down': {
					from: {
